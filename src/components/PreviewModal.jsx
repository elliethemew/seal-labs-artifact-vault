...
const PreviewModal = ({ artifact, onClose }) => {
    ...
    const handleCopyLink = () => {
        const fullUrl = `${window.location.origin}${import.meta.env.BASE_URL}${artifact.path}`;
            ...
            >
                <div className="modal-sidebar">
                    ...
                    <div className="sidebar-actions mt-auto gap-2 flex flex-col">
                        <a
                            href={`${import.meta.env.BASE_URL}${artifact.path}`}
                            target="_blank"
                ...
                <div className="preview-container">
                    <iframe
                        src={`${import.meta.env.BASE_URL}${artifact.path}`}
